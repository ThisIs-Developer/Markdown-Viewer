...
- Private repository access accepts fine-grained and classic PATs automatically. Multiple named tokens can be added, selected, and removed at any time during the current session; tokens are held only in memory and disappear on reload or app close.
