...
| Import/export | Local and GitHub branch/tag/commit import, with optional encrypted private-repository access; Markdown, HTML, Browser Print, legacy raster PDF, and PNG export |
