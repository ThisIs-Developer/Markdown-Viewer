...
- Restored the original GitHub importer widths: a compact 520px URL step and a 760px Markdown selection step. The resolved branch/ref appears directly beside the repository name, exposes its full value on hover, and is followed by the linked immutable commit; direct commit URLs show only the commit.
